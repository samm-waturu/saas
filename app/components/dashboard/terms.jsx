    ...
    <>
      ...
      <div class="privacypage">
        <div class="container small">
          ...
          <p>
            Suggested text: When visitors leave comments on the site
            we collect the data shown in the comments form, and also
            the visitor’s IP address and browser user agent string to
            help spam detection.
          </p>
          <p>
          ...
          <p>
            ...
            (EXIF GPS) included. Visitors to the website can download
          ...
          <p>
            ...
            cookies. These are for your convenience so that you do not
          ...
          <p>
            ...
            &ldquo;Remember Me&ldquo;, your login will persist for two
            weeks. If you log out of your account, the login cookies
            will be removed.
          </p>
          <p>
          ...
          <p>
            ...
            content from other websites behaves in the exact same way
          ...
          <p>
            Suggested text: If you leave a comment, the comment and
            its metadata are retained indefinitely. This is so we can
          ...
          <p>
            Suggested text: If you have an account on this site, or
            have left comments, you can request to receive an exported
            file of the personal data we hold about you, including any
            data you have provided to us. You can also request that we
