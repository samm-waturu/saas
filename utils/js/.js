    ...
    r = {
      ...
      popupMobile: function () {
        if (window.matchMedia("(max-width: 767px)").matches) {
          ...
          e(".item__popup,.fn__nav_bar .item_popup").each(
            function () {
              var a = e(this),
                o = a.parent(),
                n = t - 20,
          ...
          e(".fn__nav_bar .item_popup,.item__popup").attr(
            "style",
            ""
          );
      },
      ...
      negativePrompt: function () {
        e("#negative_prompt").on("change", function () {
          this.checked
            ? e(
                ".style_fn_image_generation_page .exclude_area"
              ).slideDown(200)
            : e(
                ".style_fn_image_generation_page .exclude_area"
              ).slideUp(200);
      ...
      imageGenerationSidebar: function () {
        e(".style_fn_image_generation_page .sidebar__trigger")
          .off()
          .on("click", function () {
            return (
              e(".style_fn_wrapper").toggleClass(
                "fn__has_sidebar"
              ),
              !1
            );
      ...
      selectModel: function () {
        e(".fn__select_model .model_open")
          ...
          e(".fn__select_model .all_models").on(
            "click",
            function (e) {
              e.stopPropagation();
            }
      ...
      anchor: function () {
        e(
          ".style_fn_doc_page .docsidebar li.menu-item-has-children > a"
        )
          .off()
          .on("click", function () {
          ...
          e().onePageNav &&
            e(".style_fn_doc_page .docsidebar > ul").onePageNav();
      },
      aiChatBot__chat: function () {
        e("#fn__chat_textarea").length &&
          !e(".style_fn_intro").length &&
          ...
          e("#fn__chat_textarea").keypress(function (t) {
            ...
            if (13 === a && t.shiftKey);
              ...
              return (
                e(".fn__chat_comment button").trigger("click"), !1
              );
          }),
              ...
              if (!("" === o || t.hasClass("disabled"))) {
                ...
                return (
                  ...
                  e(".style_fn_intro").length
                    ? e("html, body").animate({
                        scrollTop:
                          a.offset().top - e(window).height() + 100
                      })
                    : e("html, body").animate({
                        scrollTop:
      ...
      frenifyChat: function () {
        ...
        var n = {
          ...
          doc: {
            type: "url",
            description:
              "visit online documentation for style HTML template",
            append: !1,
            url: "https://frenify.com/work/envato/frenify/html/style/doc"
          },
          support: {
            type: "url",
            description:
              "if you have any questions regarding style HTML template feel free and contact us by this command",
            append: !1,
        ...
        c &&
          (t =
            '<p>I only understand some commands. Of course, this is a fixable problem. Buy this template and implement AI and that\'s it. Go to the template site where you can buy? Visit item\'s website: <a href="https://themeforest.net/user/frenify/portfolio" target="_blank">style</a></p><p>Write <frenify_main>/commands</frenify_main> to list all available commands.'),
          a &&
      ...
      aiChatBotOptions: function () {
        e(".fn__chat_link")
          ...
          .on("click", function () {
            ...
            return (
              t.hasClass("active") ||
                ...
                e(".fn__chatbot .chat__item.active").removeClass(
                  "active"
                ),
                t.addClass("active"),
                e(t.attr("href")).addClass("active"),
          ...
          e(".fn__chat_link .options__popup").on(
            "click",
            function (e) {
              e.stopPropagation();
            }
            ...
            .on("click", function () {
              ...
              if (!t.hasClass("active")) {
                ...
                o.find(".pricing__tab.active").removeClass("active"),
                  ...
                  a
                    .find(".bg")
                    .css({ left: n, width: t.outerWidth(!0, !0) });
              }
              return !1;
            });
      },
      feedFilters: function () {
        e(
          '.style_fn_feed .filter__select input[type="checkbox"]'
        ).change(function () {
          var t = e(this),
            a = t.is(":checked"),
            o = t.closest(".style_fn_feed"),
          ...
          e(".fn__selectable_item")
            ...
            .on("click", function () {
              var a = e(this),
                o = a.closest(".style_fn_community_page");
              return (
          ...
          e(".style_fn_feed .fn__tabs a").on("click", function () {
            var t = e(this);
            if (!t.hasClass("active") && !a) {
              (a = !0),
                t.siblings().removeClass("active"),
                t.addClass("active");
              var o = t.closest(".style_fn_feed");
          ...
          e(".style_fn_feed .filter__sorting a").on(
            "click",
            function () {
              var t = e(this);
          ...
          e(
            '.style_fn_feed .filter__upscaled input[type="checkbox"]'
          ).change(function () {
            var t = e(this);
            t.is(":checked");
            var a = t.closest(".style_fn_feed");
            a.find(".feed__results").addClass("loading"),
              setTimeout(function () {
                a.find(".feed__results").removeClass("loading");
              }, 1500);
          }),
          e(".style_fn_feed .filter__search a").on(
            "click",
            function () {
              if (!a) {
                var t = e(this).closest(".style_fn_feed");
                t.find(".feed__results").addClass("loading"),
                  setTimeout(function () {
                    t.find(".feed__results").removeClass("loading"),
                      (a = !1);
                  }, 1500);
              }
              return !1;
          ...
          .on("click", function () {
            ...
            return (
              ...
              t.hasClass("has__follow")
                ? (t.removeClass("has__follow"),
                  a.text(t.data("follow-text")))
                : (t.addClass("has__follow"),
                  a.text(t.data("unfollow-text"))),
              !1
            );
          });
      },
          ...
          .on("click", function () {
            ...
            return (
              ...
              t.hasClass("has__like")
                ? (t.removeClass("has__like"),
                  a.text(parseInt(a.text()) - 1))
                : (t.addClass("has__like"),
                  a.text(parseInt(a.text()) + 1)),
              !1
            );
          });
      ...
      accordion: function () {
        e(".style_fn_accordion").each(function () {
          ...
          e(".style_fn_accordion .acc__header").on(
            "click",
            function () {
              var t = e(this),
      ...
      movingSubMenuForLeftPanel: function () {
        ...
        a.on("mouseenter", function () {
          ...
          var r = o.offset().top,
            l = e(
              ".style_fn_leftpanel .leftpanel_content"
            ).offset().top;
          t.css({ top: r - l }), n();
        }),
          n();
      ...
      preloader: function () {
        var t = e(".style_fn_preloader"),
          a = new Date() - FrenifystyleTime,
          o = 4e3;
        a < o ? (o -= a) : (o = 0),
