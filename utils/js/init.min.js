...
!(function (e) {
    ...
    r = {
        ...
        e(".style_fn_user_billing .progress").each(function () {
          ...
          t.waypoint({
            handler: function () {
              t.hasClass("active") ||
                setTimeout(function () {
                  t.css("--custom-progress", t.data("percentage")),
                    t.addClass("active");
                }, 500);
            },
            offset: "90%"
      ...
      imageGenerationSidebar: function () {
        e(".style_fn_image_generation_page .sidebar__trigger")
          ...
          .on("click", function () {
            return (
              e(".style_fn_wrapper").toggleClass("fn__has_sidebar"),
              !1
            );
          });
      },
          ...
          t
            ...
            .on("click", function () {
              return (
                ...
                e("body").append(
                  '<style type="text/css" class="fn__chat_font_size_style">custom_typing h3,.fn__chatbot .chat{font-size: ' +
        ...
        e(".fn__chat_link")
          ...
          .on("click", function () {
            ...
            return (
              ...
              e("#fn__chat_textarea").customMoveCursorToEnd(),
              !1
            );
          }),
          e(".fn__new_chat_link")
  ...
  e(document).ready(function () {
    ...
    e(window).on("resize", function () {
      r.popupMobile(), r.redetectFullScreen();
    }),
