  ...
  return (
    <div className={FontFetchHeebo.className}>
      ...
      <div className="container small">
        <div className="style_fn_user_billing">
          ...
          <div className="billing__activation">
            <div className="activation_status">
              ...
              <div className="status_right">
                ...
                <span
                  className="progress"
                  data-percentage="66.66%"></span>
              </div>
            </div>

            <div className="activation_actions">
              <a href="pricing.html" className="style_fn_button">
                <span>Upgrade Plan</span>
              </a>
              <a
                href="pricing.html"
                className="disabled style_fn_button">
