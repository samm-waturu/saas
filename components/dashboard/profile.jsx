      ...
      <div className="style_fn_user_profile">
        ...
        <div class="user__interests">
          ...
          <div class="fn__options_list">
            <ul>
              <li>
                <a className="style_fn_button small__border enabled">
                  <span>Cert ICT mod: 1</span>
                </a>
              </li>
              <li>
                <a className="style_fn_button small__border disabled">
                  <span>Cert ICT mod: 2</span>
                </a>
              </li>
              <li>
                <a className="style_fn_button small__border disabled">
                  <span>Dip ICT mod: 1</span>
                </a>
              </li>
              <li>
                <a className="style_fn_button small__border disabled">
                  <span>Dip ICT mod: 2</span>
                </a>
              </li>
              <li>
                <a className="style_fn_button small__border disabled">
                  <span>Dip ICT mod: 3</span>
                </a>
              </li>
            </ul>
          </div>
